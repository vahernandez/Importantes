...
url = "https://api.meraki.com/api/v1/devices/Q2LW-89GD-FL29/switch/routing/interfaces"   #<<<<<<<<<<<<<Cambiar variable del serial
...
if response.status_code == 200:
    ...
    output_file = f"C:/RootScripts/PostOak/MW/SVIsId_{timestamp}.txt"       #<<<<<<<<<<<<<Cambiar variable del path
