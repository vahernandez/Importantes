...
serial = 'Q2LW-89GD-FL29'                                   #<<<<<<<<<<<<<Cambiar variable del serial del switch donde estan los svis

# Ruta del archivo .txt que contiene la información
input_file = "C:/RootScripts/PostOak/MW/SVIsId.txt"                    #<<<<<<<<<<<<<Cambiar variable del path e ir a la carpeta donde se encuentra el archivo que se va a leer y borrarle la fecha y la hora 
