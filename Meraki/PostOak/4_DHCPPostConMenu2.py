...
sitios = {
	'a': {'nombre': 'Servers', 'serial': 'Q2LW-89GD-FL29', 'interface_id_Servers': '3677189095748011612'}, 
	'b': {'nombre': 'Future Users', 'serial': 'Q2LW-89GD-FL29', 'interface_id_Future Users': '3677189095748011613'}, 
	'c': {'nombre': 'Management', 'serial': 'Q2LW-89GD-FL29', 'interface_id_Management': '3677189095748011620'}, 
	'd': {'nombre': 'Transit', 'serial': 'Q2LW-89GD-FL29', 'interface_id_Transit': '3677189095748011610'}, 
	'e': {'nombre': 'NPS Guest', 'serial': 'Q2LW-89GD-FL29', 'interface_id_NPS Guest': '3677189095748011617'}, 
	'f': {'nombre': 'Unused ports', 'serial': 'Q2LW-89GD-FL29', 'interface_id_Unused ports': '3677189095748011619'}, 
	'g': {'nombre': 'Printers', 'serial': 'Q2LW-89GD-FL29', 'interface_id_Printers': '3677189095748011618'}, 
	'h': {'nombre': 'NPS Radius', 'serial': 'Q2LW-89GD-FL29', 'interface_id_NPS Radius': '3677189095748011611'}, 
	'i': {'nombre': 'NPS Warehouse', 'serial': 'Q2LW-89GD-FL29', 'interface_id_NPS Warehouse': '3677189095748011614'}, 
	'j': {'nombre': 'NPSIot', 'serial': 'Q2LW-89GD-FL29', 'interface_id_NPSIot': '3677189095748011615'}, 
	'k': {'nombre': 'Camaras', 'serial': 'Q2LW-89GD-FL29', 'interface_id_Camaras': '3677189095748011616'}
}
# Pedir al usuario que seleccione el sitio
print("Seleccione el sitio donde desea aplicar la configuración:")
for key, value in sitios.items():
...
# Leer el archivo CSV con codificación UTF-8
with open(r'C:/RootScripts/PostOak/MW/NetDevPrinters.csv', newline='', encoding='utf-8') as csvfile:    #<<<<<<<<<<<<<Cambiar variable, estos son los archivos que guardan la ip vs mac address para el dhcp estatico
    reader = csv.DictReader(csvfile)
