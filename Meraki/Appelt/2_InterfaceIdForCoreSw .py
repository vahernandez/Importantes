...
url = "https://api.meraki.com/api/v1/devices/Q2LW-3D2D-LP5T/switch/routing/interfaces"   #<<<<<<<<<<<<<Cambiar variable del serial
...
if response.status_code == 200:
    ...
    output_file = f"C:/RootScripts/Appelt/MW/SVIsId_{timestamp}.txt"       #<<<<<<<<<<<<<Cambiar variable del path
