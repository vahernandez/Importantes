...
sitios = {
	'a': {'nombre': 'Servers', 'serial': 'Q2LW-3D2D-LP5T', 'interface_id_Servers': '3677189095748011651'}, 
...
# Leer el archivo CSV con codificación UTF-8
with open(r'C:/RootScripts/Appelt/MW/NetDevPrintersNew.csv', newline='', encoding='utf-8') as csvfile:    #<<<<<<<<<<<<<Cambiar variable, estos son los archivos que guardan la ip vs mac address para el dhcp estatico
    reader = csv.DictReader(csvfile)
