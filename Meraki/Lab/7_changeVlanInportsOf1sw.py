...
switches_info = {
    "TestAccess": {"serial": "Q2KW-4CY8-6FLC", "archivo": "TestAccessVlanChange.csv"},
    "Appelt_Border_Switch": {"serial": "Q2LW-3e2s-Ls5T", "archivo": "Appelt_Border_SwitchVlanChange.csv"}
}
