...
sitios = {
	'a': {'nombre': 'Servers', 'serial': 'Q2LW-8A2B-5GJM', 'interface_id_Servers': '754915887537980885'}, 
	'b': {'nombre': 'Future Users', 'serial': 'Q2LW-3D2D-LP5T', 'interface_id_Future Users': '3677189095748011657'}, 
	'c': {'nombre': 'Management', 'serial': 'Q2LW-3D2D-LP5T', 'interface_id_Management': '3677189095748011656'}, 
	'd': {'nombre': 'Transit', 'serial': 'Q2LW-3D2D-LP5T', 'interface_id_Transit': '3677189095748011649'}, 
	'e': {'nombre': 'NPS Guest', 'serial': 'Q2LW-3D2D-LP5T', 'interface_id_NPS Guest': '3677189095748011658'}, 
	'f': {'nombre': 'Unused ports', 'serial': 'Q2LW-3D2D-LP5T', 'interface_id_Unused ports': '3677189095748011659'}, 
	'g': {'nombre': 'Printers', 'serial': 'Q2LW-3D2D-LP5T', 'interface_id_Printers': '3677189095748011655'}, 
	'h': {'nombre': 'NPS Radius', 'serial': 'Q2LW-3D2D-LP5T', 'interface_id_NPS Radius': '3677189095748011650'}, 
	'i': {'nombre': 'NPS Warehouse', 'serial': 'Q2LW-3D2D-LP5T', 'interface_id_NPS Warehouse': '3677189095748011652'}, 
	'j': {'nombre': 'NPSIot', 'serial': 'Q2LW-3D2D-LP5T', 'interface_id_NPSIot': '3677189095748011653'}, 
	'k': {'nombre': 'Camaras', 'serial': 'Q2LW-3D2D-LP5T', 'interface_id_Camaras': '3677189095748011654'}
}
# Pedir al usuario que seleccione el sitio
print("Seleccione el sitio donde desea aplicar la configuración:")
for key, value in sitios.items():
...
# Leer el archivo CSV con codificación UTF-8
with open(r'C:/RootScripts/Butler/MW/AddingNetsToNormalDHCPBefore.csv', newline='', encoding='utf-8') as csvfile:    #<<<<<<<<<<<<<Cambiar variable, estos son los archivos que guardan la ip vs mac address para el dhcp estatico
    reader = csv.DictReader(csvfile)
