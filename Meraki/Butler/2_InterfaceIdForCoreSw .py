...
url = "https://api.meraki.com/api/v1/devices/Q2LW-8A2B-5GJM/switch/routing/interfaces"   #<<<<<<<<<<<<<Cambiar variable del serial
...
if response.status_code == 200:
    ...
    output_file = f"C:/RootScripts/Butler/MW/SVIsId_{timestamp}.txt"       #<<<<<<<<<<<<<Cambiar variable del path
